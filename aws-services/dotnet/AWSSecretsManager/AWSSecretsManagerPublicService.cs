...
{
    public class AWSSecretsManagerPublicService : ISecretsService
    {
        private AmazonSecretsManagerClient client;

        public AWSSecretsManagerPublicService() {
            this.client = new AmazonSecretsManagerClient(RegionEndpoint.EUCentral1);
        }
